...
class CMsgSteamDatagramSignedRelayAuthTicket : public ::google::protobuf::Message {
 public:
  ...
  static const int kCertsFieldNumber = 5;
  inline const ::CMsgSteamDatagramCertificateSigned& certs(int index) const;
  inline ::CMsgSteamDatagramCertificateSigned* mutable_certs(int index);
  inline ::CMsgSteamDatagramCertificateSigned* add_certs();
...
inline void CMsgSteamDatagramSignedRelayAuthTicket::clear_certs() {
  certs_.Clear();
}
