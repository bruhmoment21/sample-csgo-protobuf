...
void protobuf_AssignDesc_steamdatagram_5fmessages_5fauth_2eproto() {
  ...
  static const int CMsgSteamDatagramSignedRelayAuthTicket_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CMsgSteamDatagramSignedRelayAuthTicket, certs_),
  };
...
const int CMsgSteamDatagramSignedRelayAuthTicket::kCertsFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_certs;
        break;
      }
